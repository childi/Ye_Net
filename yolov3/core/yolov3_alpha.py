...
class YOLOV3(object):
    ...
    def __build_nework(self, input_data, avod=None):
        ...
        conv_lbbox = common.convolutional(conv_lobj_branch, (1, 1, 1024, 3*(self.num_class + 7)),
        ...
        conv_mbbox = common.convolutional(conv_mobj_branch, (1, 1, 512, 3*(self.num_class + 7)),
        ...
        conv_sbbox = common.convolutional(conv_sobj_branch, (1, 1, 256, 3*(self.num_class + 7)),
    ...
    def decode(self, conv_output, anchors, stride):
        ...
        return tf.concat([pred_xywh, pred_conf, pred_alpha, pred_prob], axis=-1)
    ...
    def loss_layer(self, conv, pred, label, bboxes, anchors, stride):
        ...
        conv = tf.reshape(conv, (batch_size, output_size, 3 * output_size,
                                 self.anchor_per_scale, 7 + self.num_class))
        ...
        return giou_loss, conf_loss, prob_loss, alpha_loss
    ...
    def compute_loss(self, label_sbbox, label_mbbox, label_lbbox, true_sbbox, true_mbbox, true_lbbox):
        ...
        with tf.name_scope('alpha_loss'):
            alpha_loss = loss_sbbox[3] + loss_mbbox[3] + loss_lbbox[3]
...
class DARKNET(object):
    ...
    def __init__(self, input_data, trainable):
        ...
        self.trainable        = trainable
        self.classes          = utils.read_class_names(cfg.YOLO.CLASSES)
        self.num_class        = 1  # len(self.classes)  # for avod, when class=car
        self.strides          = np.array(cfg.YOLO.STRIDES)
        self.anchors          = utils.get_anchors(cfg.YOLO.ANCHORS)
        self.anchor_per_scale = cfg.YOLO.ANCHOR_PER_SCALE
        self.iou_loss_thresh  = cfg.YOLO.IOU_LOSS_THRESH
        ...
        source, source_2, source_4, route_1, route_2, input_data = backbone.darknet53(input_data, self.trainable)
        # self.darknet53_output = darknet53_output  # self.darknet53_output = torch.tensor( )
