...
class YOLOV3(object):
    ...
    def decode(self, conv_output, anchors, stride, cam_p2_I):
        ...
        input_data = common.convolutional(conv_output, (1, 1, 3*(self.num_class + 5), 128), self.trainable, 'extra_conv_z1')
        input_data = common.convolutional(input_data, (3, 3, 128, 256), self.trainable, 'extra_conv_z2')
        input_data = common.convolutional(input_data, (1, 1, 256, 128), self.trainable, 'extra_conv_z3')
        # input_data = common.convolutional(input_data, (3, 3, 128, 256), self.trainable, 'extra_conv_z4')
        # input_data = common.convolutional(input_data, (1, 1, 256, 128), self.trainable, 'extra_conv_z5')
        conv_raw_z = common.convolutional(input_data, (1, 1, 128, 3*1), self.trainable, 'conv_z',
        ...
        conv_raw_z = tf.reshape(conv_raw_z, (batch_size, output_size, 3 * output_size, anchor_per_scale, 1))
