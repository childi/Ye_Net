...
def flip_label(obj_label, image_input):
    ...
    _, w, _ = image_input.shape
    flipped_label.x2 = w - flipped_label.x1
    flipped_label.x1 = w - flipped_label.x2

    # Flip the rotation
    if obj_label.ry >= 0:
        flipped_label.ry = np.pi - obj_label.ry
        flipped_label.alpha = np.pi - obj_label.alpha
    else:
        flipped_label.ry = -np.pi - obj_label.ry
        flipped_label.alpha = -np.pi - obj_label.alpha
