...
from avod.datasets.kitti.kitti_dataset_val import KittiDatasetVal
...
class DatasetBuilder(object):
    ...
    @staticmethod
    def build_kitti_dataset_test(base_cfg,
                                 use_defaults=True,
                                 new_cfg=None) -> KittiDatasetVal:
        cfg_copy = DatasetBuilder.copy_config(base_cfg)
        ...
        return KittiDatasetVal(cfg_copy)
