...
from avod.core.feature_extractors.bev_vgg_pyramid_dw import BevVggPyrDw
...
from avod.core.feature_extractors.img_vgg_pyramid_dw import ImgVggPyrDw
...
def get_extractor(extractor_config):
    ...
    elif extractor_type == 'bev_vgg_pyr_dw':
        return BevVggPyrDw(extractor_config.bev_vgg_pyr_dw)
    ...
    elif extractor_type == 'img_vgg_pyr_dw':
        return ImgVggPyrDw(extractor_config.Img_vgg_pyr_dw)
