...
class ImgVggPyrDw(img_feature_extractor.ImgFeatureExtractor):
    ...
    def build(self,
        ...
        Args:
            inputs: a tensor of size [batch_size, height, width, channels].    #img[1, 1200, 360, 3],bev[1, 700, 800, 6]
            input_pixel_size: size of the input (H x W)                        #img[1200, 360],bev[none, none]
        ...
        with tf.variable_scope('img_vgg_pyr', [inputs]) as sc:
            ...
            with slim.arg_scope([slim.convolution2d, slim.separable_convolution2d, slim.max_pool2d],
                ...
                with slim.arg_scope([slim.convolution2d, slim.separable_convolution2d],
                    ...
                    with slim.arg_scope([slim.batch_norm],
                                        ...
                                        fused=True):
                        conv1 = dwconv(inputs, vgg_config.vgg_conv1[1], sc='conv1')
