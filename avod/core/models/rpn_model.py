...
from yolov3.core.yolov3_z import DARKNET
...
class RpnModel(model.DetectionModel):
    ...
    def create_feed_dict(self, sample_index=None):
        ...
        avod_class = self.dataset.classes
        box_path = os.path.join('../../yolov3/mAP/mapp/predicted_trainzz_0.1/', str(int(sample_name)) + '.txt')
    ...
    def preprocess_true_boxes(self, bboxes):
        ...
        anchors_path = "../../yolov3/data/anchors/basline_anchors.txt"
